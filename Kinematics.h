...
enum {IKM_IK3D_CARTESIAN, IKM_IK3D_CARTESIAN_90, IKM_CYLINDRICAL, IKM_CYLINDRICAL_90, IKM_BACKHOE};


// status messages for IK return codes..
enum {IKS_SUCCESS=0, IKS_WARNING, IKS_ERROR};
...
byte     g_bIKMode = IKM_IK3D_CARTESIAN;   // Which mode of operation we are in...
